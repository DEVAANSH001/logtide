...
> **🚀 RELEASE 0.8.2:** LogTide now supports **Multi-Engine Storage** (ClickHouse, MongoDB) and **Advanced Browser Observability**.
...
### Performance & Metrics (New in 0.8.2)
